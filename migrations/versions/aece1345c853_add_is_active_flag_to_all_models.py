...
TABLES = [
    'ai_chat_message', 'ai_conversation', 'appointment', 'appointment_game',
    'chat', 'chat_participant', 'contact_message', 'daily_report', 'expense',
    'message', 'monthly_report', 'notification', 'payment', 'quarterly_report',
    'session_audit', 'session_image', 'session_metrics', 'weekly_report', 'yape_transaction',
]
