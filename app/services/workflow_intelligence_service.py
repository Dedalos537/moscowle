...
class WorkflowPattern:
    ...
    def __init__(self):
        ...
        self.common_parameters = defaultdict(Counter)
    ...
    def get_predicted_parameters(self, intent):
        ...
        return {'most_used': params.most_common(3), 'frequency': dict(params)}

    def export_stats(self):
        """Exporta estadísticas del patrón"""
        avg_time = (sum(self.time_between_actions) / len(self.time_between_actions)) if self.time_between_actions else 0
        ...
        return {
            ...
            'intent_sequence': self.intent_sequence[-10:],
