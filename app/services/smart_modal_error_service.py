...
class SmartModalError:
    ...
    def __init__(self, title, message, severity=ErrorSeverity.ERROR, action_button=None, details=None, error_code=None):
        """
...
def create_error_response(error_obj, status_code=400):
    ...
    error_obj.log()
    return {'success': False, **error_obj.to_dict()}, status_code
