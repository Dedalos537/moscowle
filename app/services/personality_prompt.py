...
LOCAL_BASE_PROMPT = (
    ...
    '- Para consultar o registrar CUALQUIER dato de un paciente, NUNCA inventes el patient_id: '
    'primero llama search_patients con el nombre y usa el id REAL que devuelve.\n'
    ...
    '- Para una acción de escritura (crear/registrar/editar): si faltan parámetros obligatorios, pídelos de a uno; '
    'cuando los tengas todos, emite la llamada a la herramienta (el sistema pedirá confirmación final al usuario).\n'
