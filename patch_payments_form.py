...
content = content.replace('<div class="mb-4">\n                <label class="block text-xs font-bold text-charcoal uppercase mb-1">Monto a Pagar (S/)</label>', new_fields + '                <label class="block text-xs font-bold text-charcoal uppercase mb-1">Monto a Pagar (S/)</label>')

content = content.replace('<div class="mb-4">\n                <label class="block text-xs font-bold text-gray-500 uppercase mb-1">Monto a Pagar (S/)</label>', new_fields + '                <label class="block text-xs font-bold text-gray-500 uppercase mb-1">Monto a Pagar (S/)</label>')
