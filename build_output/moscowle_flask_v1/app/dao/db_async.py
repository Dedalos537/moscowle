...
# For production MySQL: mysql+aiomysql://user:pass@host/db
# For dev SQLite: sqlite+aiosqlite:///instance/moscowle.db
...
try:
    ...
    # Fallback/Error handling if async driver is missing
...
# Async Session Factory (Define if engine exists)
if async_engine:
    try:
    ...
    # Ensure variable is defined even if engine failed
