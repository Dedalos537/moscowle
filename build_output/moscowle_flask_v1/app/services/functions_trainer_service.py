"""
Functions Trainer Service - Entrena a la IA con TODAS las funciones disponibles
Permite que la IA entienda qué acciones PUEDE realizar
"""
import json
import logging
...
# Mapeo completo de funciones disponibles con ejemplos
ADMIN_FUNCTIONS = {
    'view_unpaid_users': {
    ...
    'register_payment': {
        ...
        'examples': [
            ...
            'Cobré S/.300 a María',
            'Nuevo ingreso de S/.450 por terapia'
        ],
    ...
    'create_expense': {
        ...
        'examples': [
            'Gasto de S/.250 en útiles',
            'Registra costo de S/.500 para servicios',
            'Nuevo egreso de S/.150'
        ],
    ...
    'assign_therapist': {
        ...
        'examples': [
            ...
            'Vincula a Pedro con especialista'
        ],
